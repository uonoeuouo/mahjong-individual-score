...
DAILY_SHEET_FORMULAS = [
    ["No. / 選手名", ""],
    ["合計スコア", '=BYCOL($B$10:$ZZ, LAMBDA(c, IF(INDEX($1:$1, 1, COLUMN(c))="", "", SUM(c) + IFERROR(INDEX($8:$8, 1, COLUMN(c)), 0) * -20)))'],
    ["1着数", '=BYCOL($B$10:$ZZ, LAMBDA(c, IF(INDEX($1:$1, 1, COLUMN(c))="", "", SUM(MAP(SEQUENCE(ROWS(c)), LAMBDA(r, IF(INDEX(c, r)="", 0, IF(AND(COUNTIF(INDEX($B$10:$ZZ, r), ">"&INDEX(c, r)) + 1 <= 1, 1 <= COUNTIF(INDEX($B$10:$ZZ, r), ">"&INDEX(c, r)) + COUNTIF(INDEX($B$10:$ZZ, r), INDEX(c, r))), 1 / COUNTIF(INDEX($B$10:$ZZ, r), INDEX(c, r)), 0))))))))'],
    ["2着数", '=BYCOL($B$10:$ZZ, LAMBDA(c, IF(INDEX($1:$1, 1, COLUMN(c))="", "", SUM(MAP(SEQUENCE(ROWS(c)), LAMBDA(r, IF(INDEX(c, r)="", 0, IF(AND(COUNTIF(INDEX($B$10:$ZZ, r), ">"&INDEX(c, r)) + 1 <= 2, 2 <= COUNTIF(INDEX($B$10:$ZZ, r), ">"&INDEX(c, r)) + COUNTIF(INDEX($B$10:$ZZ, r), INDEX(c, r))), 1 / COUNTIF(INDEX($B$10:$ZZ, r), INDEX(c, r)), 0))))))))'],
